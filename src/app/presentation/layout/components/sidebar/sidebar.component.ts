...
import { ILayout,   } from '@presentation/layout/core/configs/config';
...
import {SidebarFooterComponent} from "@presentation/layout/components/sidebar/sidebar-footer/sidebar-footer.component";

@Component({
    selector: 'app-sidebar',
    imports: [SidebarLogoComponent,SidebarFooterComponent, SidebarMenuComponent],
