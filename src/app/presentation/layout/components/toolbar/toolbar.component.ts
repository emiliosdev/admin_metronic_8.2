...
import { ILayout, LayoutType } from '@presentation/layout/core/configs/config';
...
@Component({
    ...
    imports: [NgClass, PageTitleComponent, ClassicComponent, AccountingComponent, ExtendedComponent, ReportsComponent, SaasComponent],
