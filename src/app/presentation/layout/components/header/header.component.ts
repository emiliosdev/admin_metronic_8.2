...
import { MenuComponent } from '@presentation/layout/kt/components';
import { ILayout, LayoutType } from '../../core/configs/config';
import { CommonModule, NgClass } from '@angular/common';
import { KeeniconComponent } from '@presentation/shared/components/keenicon/keenicon.component';
import { NavbarComponent } from './navbar/navbar.component';
import {HeaderMenuComponent} from "@presentation/layout/components/header/header-menu/header-menu.component";

@Component({
    selector: 'app-header',
    imports: [CommonModule,KeeniconComponent,HeaderMenuComponent, NavbarComponent],
